...
For consistency and compatibility across the three different sections, system engineering, mission control and rocket simulator, the same API should be used. Using the same API also ensures that the final avionics package will work as a whole. 
