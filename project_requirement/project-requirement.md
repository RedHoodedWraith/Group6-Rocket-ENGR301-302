...
To meet the requirements of easy installation, the avioinics package must be assembled into a single unit, with the exception of the battery unit. The avionics package must also be fixated with the rocket housing without any wobble.
